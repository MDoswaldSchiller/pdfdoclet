...
public class JavadocUtil implements IConstants {
     ...
     * 
     * @param classDoc
     *            The class or interface whose name should be returned.
     ...
     * 
     * @param qualifiedName
     *            The qualified name of the class or interface.
     * @return The short or fully qualifed name of the class or interface.
     */
     ...
     * 
     * @param classDoc
     *            The ClassDoc for the given class.
     ...
     * 
     * @param methodDoc
     *            The MethodDoc for the given method.
     * @return A text String with all modifiers.
     */
     ...
     *            The ConstructorDoc for the given constructor.
     * @return A text String with all modifiers.
     */
     ...
     * 
     * @param fieldDoc
     *            The FieldDoc for the given field.
     * @return A text String with all modifiers.
     */
     ...
     *            destination table
     * @param pos
     *            from where must be included source table into destination
     *            table
     * @param classes
     *            table, to be included into destination table
     */
     ...
     * 
     * @param parm
     *            The parameter whose type is to be determined.
     ...
     * @param method
     *            The method name and optionally signature.
