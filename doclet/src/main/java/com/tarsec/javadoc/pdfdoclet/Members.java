...
public class Members implements IConstants
{
   ...
   * @param returnType Phrase with the return type text (might be a hyperlink)
   ...
   * @param thrownExceptions Exceptions of a method, null for a field or
   * constructor.
   * @param isFirst True if it is the first field/method/constructor in the
   * list.
