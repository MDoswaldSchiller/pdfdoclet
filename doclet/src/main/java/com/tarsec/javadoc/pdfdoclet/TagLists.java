...
public class TagLists implements IConstants {
     ...
     * 
     * @param names
     *            The list of all tags of a method.
     ...
     * @param isKeyValue Some tags, like exceptions, consist of two parts. The first is
     *            the first word - the exception name - and the second is the
     *            rest, which is the explanation for the exception. This
     *            parameter designates the tag(s) to be of this type if true.
     * @throws Exception
     */
