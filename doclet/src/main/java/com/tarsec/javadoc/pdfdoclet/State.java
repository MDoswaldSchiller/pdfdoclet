...
public class State
{
  ...
  /**
   * Returns the type of the member which is currently being processed
  ...
  /**
   * Sets the type of the member which is currently being processed
   * (constructor, field, method).
   *
   * @param type The type of the member (must be one of the constant values of
   * this class).
   */
...
//  }
  ...
  /**
   * Determines if currently an overview page is being processed.
   *
  ...
  /**
   * Defines if currently an overview page is being processed.
   *
  ...
  /**
   * Returns the number of the current package method (used for the navigation
   * frame entry numbering).
   *
  ...
  /**
   * Increases the number of the current package method (used for the navigation
   * frame entry numbering).
   */
  ...
  /**
   * Returns the number of the current package section (used for the navigation
   * frame entry numbering).
   *
  ...
  /**
   * Increases the number of the current package section (used for the
   * navigation frame entry numbering).
   */
  ...
  /**
   * Returns the number of the current package chapter (used for the navigation
   * frame entry numbering).
   *
  ...
  /**
   * Increases the number of the current package chapter (used for the
   * navigation frame entry numbering).
   */
